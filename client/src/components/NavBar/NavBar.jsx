...
const NavBar = () =>{
    return(
      ...
      <nav className="relative flex flex-no-wrap items-center justify-between w-full py-2 shadow-md bg-neutral-100 shadow-black/5 dark:bg-neutral-600 dark:shadow-black/10 lg:flex-wrap lg:justify-start lg:py-4" data-te-navbar-ref>
        ...
        {/* <a className="flex items-center mt-3 mb-4 mr-2 text-neutral-900 hover:text-neutral-900 focus:text-neutral-900 dark:text-neutral-200 dark:hover:text-neutral-400 dark:focus:text-neutral-400 lg:mb-0 lg:mt-0"
          href="#">
          <img
        ...
        <ul className="flex flex-col pl-0 mr-auto list-style-none lg:flex-row"
